...
'dev_cap 
sql = "truncate device_cap;"
myrs.open sql,mycn 
sql  =	"load data local infile ""C:/optimizer/extn_files/device_cap.csv"" into table device_cap fields terminated by ',' lines terminated by '\n'" & _
		" IGNORE 1 LINES;"
myrs.open sql,mycn
