...
inline bool prev_combination(BidIt n_begin, BidIt n_end, BidIt r_begin,
                             BidIt r_end) {
    ...
    for (BidIt n_it1 = tmp_n_end; n_it1 != n_begin || n_it1 == n_begin;
            --n_it1) {
        if (*r_it1 == *n_it1) {
            r_marked = r_it1;
            n_marked = n_it1;
    ...
    for (BidIt r_it2 = r_marked; r_it2 != r_begin || r_it2 == r_begin;
            --r_it2, --n_it2) {
        if (*r_it2 == *n_it2) {
                ...
                for (BidIt n_it3 = n_begin; n_it3 != n_end; ++n_it3) {
                    if (*r_it2 == *n_it3) {
                        ...
                        *r_it2 = *(--n_it3);
                        ...
                        BidIt n_it4 = n_end;
                        --n_it4;
                        for (BidIt r_it3 = tmp_r_end;
                                (r_it3 != r_begin || r_it3 == r_begin)
            ...
            for (BidIt n_it5 = n_begin; n_it5 != n_end; ++n_it5) {
                if (*r_it2 == *n_it5) {
                    *r_it2 = *(--n_it5);
                    ...
                    BidIt n_it6 = n_end;
                    --n_it6;
                    for (BidIt r_it4 = tmp_r_end;
                            (r_it4 != r_begin || r_it4 == r_begin)
                            && r_it4 != marked; --r_it4, --n_it6) {
                        *r_it4 = *n_it6;
                    }
                    return true;
                }
...
void recursive_combination(RanIt nbegin, RanIt nend, int n_column, RanIt rbegin,
                           RanIt rend, int r_column, int loop, Func func) {
    ...
    for (int i = 0; i <= loop; ++i) {
        ...
        *it1 = *it2;
        ...
        recursive_combination(nbegin, nend, local_n_column, rbegin, rend,
                              r_column + 1, localloop, func);
        --localloop;
    }
