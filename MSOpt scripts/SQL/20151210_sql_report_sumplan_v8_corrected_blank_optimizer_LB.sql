...
description:
- corrected the blank optimizer LB, because of same initial LB with route
- corrected hours is null
 ...
 */
 ...
 UNION 
 select sp_hr_i.MI, sp_hr_i.MF, sp_hr_i.PKG_SIZE, sp_hr_i.LB as LB,    
                                 case when (coalesce(trim(sp_hr_i.TF),'') <> '') then sp_hr_i.TF else sp_hr_i.initial_tool_family end as TF,
